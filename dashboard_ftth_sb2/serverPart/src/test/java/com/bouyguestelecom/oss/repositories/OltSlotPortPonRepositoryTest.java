...
public class OltSlotPortPonRepositoryTest {
    ...
    /*@Test
    public void testGetDistinctOlt() {
        List<String> distinctsOlts = oltSlotPortPonRepository.getDistinctOlt();
        Assertions.assertEquals(2, distinctsOlts.size());


    }*/

    @Test
    public void testFindByOspIdContaining() {
        List<OltSlotPortPon> osps = oltSlotPortPonRepository.findByOspIdContaining("OLT0116");
        Assertions.assertEquals(2, osps.size());
